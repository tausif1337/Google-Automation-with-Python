...
```
## I have no idea why Qn2 was flagged as wrong
...
# I apologise for writing the question below horribly. I couldn't figure an answer that only took in US zip codes. I am not that good at regex
...
def check_zip_code (text):
  result = re.search(r"(?:New York|Main Street)", text)
  return result != None
