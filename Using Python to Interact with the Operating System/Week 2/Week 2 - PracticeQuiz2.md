...
def parent_directory():
  ...
  c_path = os.getcwd() # Get path of current directory
  relative_parent = os.path.join(c_path, os.pardir)
  abs_parent = os.path.abspath(relative_parent)
